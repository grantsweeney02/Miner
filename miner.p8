...
function _update()
    ...
    if miner.x % GRID_SIZE == 0 and miner.y % GRID_SIZE == 0 then
        ...
        for s = 1, steps do
            ...
            elseif btn(3) and miner.y < (BEDROCK_LEVEL - 1) * GRID_SIZE then
                new_y += miner.speed
